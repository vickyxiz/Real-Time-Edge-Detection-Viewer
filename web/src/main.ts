...
const sampleFrameBase64: string = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";

function displayFrame() {
    const frameElement = document.getElementById('processed-frame') as HTMLImageElement;
